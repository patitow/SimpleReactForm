...
function CInput({label,type}) {
    ...
    const defaultInputClassName="input mt-2 border rounded-full w-full py-3 px-4 text-gray-700 leading-tight focus:outline-offset-0 focus:shadow-outline focus:outline-blue-900 text-center";
    const defaultLabelClassName="label text-2xl font-semibold leading-tight text-gray-800 text-center mt-3";    
